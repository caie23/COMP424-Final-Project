...
1. Modify or copy the [`student_agent.py`](agents/student_agent0.py) file in [`agents/`](agents/) directory, which extends the [`agents.Agent`](agents/agent.py) class. 
...
1. All of your modifications must be done *ONLY* in the [`student_agent.py`](agents/student_agent0.py) file, which you will submit on My Courses.
